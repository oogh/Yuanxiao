...
public class DetailFoundActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        initToolbar();
        mTitle = (TextView) findViewById(R.id.tv_found_detail_title);
        mTime = (TextView) findViewById(R.id.tv_found_detail_time);
        mPhone = (TextView) findViewById(R.id.tv_found_detail_phone);
        mDescribe = (TextView) findViewById(R.id.tv_found_detail_describe);
        mDeleteButton = (FloatingActionButton) findViewById(R.id.fab_found_detail_delete);
        mCallButton = (FloatingActionButton) findViewById(R.id.fab_found_detail_call);
    ...
    private void initToolbar() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_detail_found);
    ...
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.fab_found_detail_delete:
                Snackbar.make(v, "确定删除？", Snackbar.LENGTH_LONG).setAction("确定", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Found found = new Found();
                        found.setObjectId(mBundle.getString("objectid"));
                        found.delete(new UpdateListener() {
                            @Override
                            public void done(BmobException e) {
                                if (e == null) {
                                    Toast.makeText(DetailFoundActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
                                    setResult(1);
                                    finish();
                                } else {
                                    Toast.makeText(DetailFoundActivity.this, "删除失败，请重试", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                ...
                break;
            case R.id.fab_found_detail_call:
